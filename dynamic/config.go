...
type Configuration struct {
	...
	TCP  interface{}        `json:"tcp,omitempty" toml:"tcp,omitempty" yaml:"tcp,omitempty" export:"true"`
...
func (c *Configuration) GetTCP() *TCPConfiguration {
	if c.TCP == nil {
		return nil
	}
	tcpConfig, ok := c.TCP.(*TCPConfiguration)
	if !ok {
		return nil
	}
	return tcpConfig
...
type TLSConfiguration struct {
	Certificates []*tls.CertAndStores   `json:"certificates"  toml:"certificates" yaml:"certificates" label:"-" export:"true"`
